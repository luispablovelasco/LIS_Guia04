...
$materias = array(
        ...
        "Programación Orientada a Objetos I" => array(
                ...
                'Raphael Varane' => 5.8,
                'José Ignacio Fernandez Iglesias' => 9.2,
...
//Creando la página web con cadenas usando la sintaxis HERE DOC
echo "<!DOCTYPE html>";
echo "<html>";
echo "<head>";
...
echo "<a class='navbar-brand' class='d-inline-block aling-top' href='#'>";
echo "<img src='img/udb.jpg' style='width: 8rem; height:8rem;'>";
